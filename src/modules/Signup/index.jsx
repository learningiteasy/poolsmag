                ...
                <form noValidate={true}>
                    <div className="step-1 pb-5">
                        ...
                        <div className="form-group">
                            ...
                            <p style={{ display: "none" }} ref={PhoneElvalidation} className="error-message">Please enter valid Phone Number. Phone Number must be integers [0-9]</p>
                        </div>
                        <div className="form-group">
                        ...
                        <div class="form-group text-right mb-0 steps-control">
                            <a href="javascript:void(0)" onClick={handleSumbit} class="btn btn-primary" id="steps-next">Next</a>
                        </div>
                    </div>
                </form> :
                <BusinesSignUp />}
