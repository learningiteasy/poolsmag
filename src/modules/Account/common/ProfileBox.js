...
const ProfileBox = ({ AccountState, dispatch, check_individual  }) => {
    ...
    const handleUpdate = () => {
        ...
        // const specializations = specialization.map((data) => data.value)
        ...
        window.setTimeout(() => {
            ...
            if (!!showProjectsDialog) {
                let generaldata = {
                    ...
                    skills:!!getProfileResponse.skills? getProfileResponse.skills.map((data) => { return { value: data.id, label: data.name } }): [],
    ...
    return (
        <div className="profile__box">
            <div className="profile__box__heading d-flex align-items-center justify-content-between">
                <h3 className="text-uppercase">General 
               
                <i className="ri-edit-box-line general-edit" ref={hideGeneralEl} onClick={showGeneralModel} />
                </h3>
            ...
            <div className="edit-general">
                ...
                <div className="tab-content">
                    <div className="tab-pane active" id="intro">
                        ...
                        <textarea name="intro" id className="form-control" value={intro} onChange={handleChange} placeholder="Brief Intro about your business" />
                    </div>
                    {!!check_individual && check_individual == "true" ?
                        <div className="tab-pane" id="work">
                            <h6 className="text-uppercase mb-3">Enter the Work</h6>
                            <Input type="text" name="work" class="form-control" value={work} placeholder="Your Job" onChange={handleChange} />
                        </div> :
                        <div className="tab-pane" id="specialization">
                            ...
                            {/* <Select
                                ...
                                options={AccountState.specializationList.map((data) => { return { value: data.id, label: data.name } })}
                                isMulti={true}
                                onChange={(data) => console.log(data , "data spec")}
                                /> */}

                            <Input type="text"   placeholder="Company specialization" name="specialization" class="form-control" value={specialization} onChange={handleChange} />
                        </div>}
                    {!!check_individual && check_individual == "true" ?
                        ...
                        <div className="tab-pane" id="Expertise">
                            ...
                            <Input type="text" name="expertise" class="form-control" value={expertise} placeholder="Business field of expertise" onChange={handleChange} />
                        </div>}
                    <div className="tab-pane" id="Address">
                        ...
                        {/* <GooglePlacesAutocomplete
                            autoComplete="none"
                            type="text"
                            apiKey={"AIzaSyBrRliKWS9OQOQuN3n9NpfPKq6sYIpDxLg"}
                            selectProps={{
                                value: { value: address, label: address },
                                onChange: (value) => handleChange({ target: { name: "address", "value": value.label } })
                            }}
                            name="address"
                    ...
                    <div className="tab-pane" id="Language">
                        ...
                        <Select
                            placeholder={check_individual == "true" ? "Languages you speak" : "Languages spoken in your business"}
                            value={language}
            ...
            <div className="user-info">
                ...
                {!!check_individual && check_individual == "true" ?
                    ...
                    <div className="user-info__blk">
                        ...
                        <p> {!!getProfileResponse.expertise ? getProfileResponse.expertise : ""}
                           </p>
                    </div>}
                <div className="user-info__blk">
