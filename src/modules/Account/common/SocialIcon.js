...
import { SocialIconValidation } from '../validations'
...
const SocialIcon = ({ AccountState  }) => {
    ...
    const { addSocialIconApi: { addSocialSucess, addSocialMessage ,addSocialStatus } } = AccountState
    ...
    return (
        <div className="profile__box">
            <div className="profile__box__heading d-flex align-items-center justify-content-between">
                <h3 className="text-uppercase">Social media Links 
               
                <i className="ri-edit-box-line socail-media-setting" ref={openIconForm} onClick={showIconForm} /></h3>
            </div>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="form-group">
                                ...
                                <div className="social-media-field">
                                    ...
                                    <Input type="text" name="youtube" class="form-control" value={youtube} placeholder="Youtube channel" onChange={handleChange} />
                                </div>
                        ...
                        <div className="col-md-6">
                            <div className="form-group">
                                ...
                                <div className="social-media-field">
                                    <Input type="text" name="twitter" class="form-control" value={twitter} placeholder="Twitter account" onChange={handleChange} /><i className="ri-twitter-line" /></div>
                        ...
                        <div className="col-md-6">
                            <div className="form-group">
                                ...
                                <div className="social-media-field">
                                    ...
                                    <Input type="text" name="linkedin" class="form-control" value={linkedin} placeholder="Linkedin account" onChange={handleChange} />
                                </div>
                        ...
                        <div className="col-md-6">
                            <div className="form-group">
                                ...
                                <div className="social-media-field">
                                    ...
                                    <Input type="text" name="facebook" class="form-control" value={facebook} placeholder="Facebook page or account" onChange={handleChange} />
                                </div>
