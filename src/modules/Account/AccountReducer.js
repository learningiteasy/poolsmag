...
export const AccountReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case GET_PROFILE_SUCCESS:
            ...
            const { response: { data: { success, message, data } } } = action;
            let profileApiSucess = {
                getPrifileLoading: false,
                getProfileStatus: 200,
                getProfileResponse: data,
                getProfileSucess: success
            }
            let basicData = {
                profileImage: data.profile_image,
                profileImgData: IMAGE_BASE_URL + data.profile_image,
        ...
        case CLEAR_PROFILE_RESPONSE:
            ...
            return {
                ...state,
                ...{
                    inviteApiResponse: { ...state.inviteApiResponse, ...clearProfileApi },
        ...
        case UPDATE_ADDITIONAL_INFO_SUCCESS:
            ...
            let updateSuccess = {
                updateAdditionLoading: false,
                updateAdditionStatus: 200,
                updateAdditionMessage: action.response.data.message,
                updateAdditionSucess: action.response.data.success
            }
        ...
        case SAVE_MY_PROJECTS_SUCCESS:
            let saveMyProjectsSuccess = {
                saveMyProjectsLoading: false,
                saveMyProjectsStatus: 200,
                saveMyProjectsMessage: action.response.data.message,
                saveMyProjectsSucess: action.response.data.success
            }
     ...
     */
        ...
        case ADD_SOCIAL_ICON_SUCCESS:
            ...
            let addIconSuccess = {
                addSocialLoading: false,
                addSocialStatus: 200,
                addSocialSucess: action.response.data.success,
