...
import {
    ...
    GET_EMPLOYMENTS_API, SAVE_MY_EMPLOYMENTS_API, DELETE_EMPLOYMENT_API, UPDATE_EMPLOYMENT_API, GET_SOCIAL_ICON_API, ADD_SOCIAL_ICON_API, SPECIALIZATION_LIST_API
} from "../urls"
...
const specializationListApi = () => {
    return {
        [GET_API]: {
            ...
            types: [SPECIALIZATION_LIST_REQUEST,
                SPECIALIZATION_LIST_SUCCESS,
                SPECIALIZATION_LIST_FAILURE],
        }
    }
...
export {
    ...
    getSocialIconApi, addSocialIconApi ,specializationListApi
}
